      ...
      <div className="w-1/3 border rounded-b-md sticky top-6">
         ...
         <div className="p-6">
            ...
            <div className="flex items-center justify-between pt-3">
               ...
               <p className="text-gray-900">{meetTime}</p>
            </div>
            <div className="flex items-center justify-between pt-3">
            ...
            <button
               ...
               className="w-full mt-7 block text-center text-md border-2 border-secondary hover:text-secondary hover:bg-transparent bg-secondary text-white rounded-md py-3">
               {!isLoading ? (
                  "Confirm and Pay"
               ) : (
                  <svg
                     aria-hidden="true"
                     role="status"
                     className="inline w-6 h-6 ml-3 text-primary animate-spin"
                     viewBox="0 0 100 101"
                     fill="none"
